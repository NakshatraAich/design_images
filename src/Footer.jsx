...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col bg-brandColor ">
      <div className="bg-brandColor flex flex-row justify-between tracking-widest py-32 px-[200px]">
        <div>
          <img src={logo_alt} width={300} />
        ...
        <form className="flex flex-col font-Inter sm:text-sm text-xs" action="" method="POST" style={{ flex: 4/6 }}>
          <h1 className="text-white text-2xl font-semibold pb-4">Send Us Your Inquiries!</h1>
