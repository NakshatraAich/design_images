    ...
    <section className="flex flex-col-reverse xl:flex-row px-[30px] sm:px-[90px] xl:px-[160px] justify-between items-center tracking-widest xl:py-4 pt-4 pb-16">
        <div className="flex flex-col gap-8 sm:gap-12 xl:pb-16 xl:self-center self-start">
            <div className="flex flex-col gap-2">
                <div className="text-4xl sm:text-6xl text-textColor font-semibold">Lorem ipsum <br className="xl:block hidden"/> dolor sit amet.</div>
                <div className="text sm:text-lg text-altTextColor font-regular">Lorem ipsum dolor sit amet. Lorem ipsum <br className="xl:block hidden"/> dolor sit amet.</div>
            </div>
